...
ascribe scans R projects for package and function use. Other packages
can use the results to generate citations without maintaining their own
parser.

## Installation

You can install the development version of ascribe from
